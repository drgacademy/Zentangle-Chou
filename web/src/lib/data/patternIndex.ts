/**
 * Pattern showcase data for the homepage Pattern Index scene
 * and the Tangles dictionary page.
 */
...
export type PatternCard = {
  ...
  nameZh: string;
  nameEn: string;
  origin: string; // who designed it (Maria/Rick/Linda Genaw etc — public Zentangle history)
};
